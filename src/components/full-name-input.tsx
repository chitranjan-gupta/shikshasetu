...
export const FullnameInput: FC<FullnameInputProps> = ({
  form,
  property,
  description,
}) => {
  ...
  const inputValue = form.getValues(property.value as keyof FormSchemaType);
  useEffect(() => {
    form.setValue('full_name', `${firstName} ${middleName} ${lastName}`);
  }, [firstName, middleName, lastName, form]);
  return (
